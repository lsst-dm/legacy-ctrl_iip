...
from RegisterMachine import RegisterMachine
...
class Distributor:
    ...
    def __init__(self):
        ...
        # data map
        try:
            self._name = cdm["USRNAME"]  
            self._passwd = cdm["PASSWD"] 
            self._fqn_name = cdm["FQN"] 
            self._ncsa_broker_addr = "141.142.208.241/%2fbunny" 
            ...
            self._target_dir = "/home/" + self._name + "/xfer_dir/"  
            self._sentinel_file = "sentinel.fits"
...
####  Checking for and processing image file goes here
    ...
    def register(self):
        ...
        machine.register()        
        machine_info = machine.return_listener() 
        return machine_info
