...
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=ocs_dmcs_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=dmcs_ack_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=dmcs_ocs_publish
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=ar_foreman_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=pp_foreman_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=cu_foreman_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=archive_ctrl_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=archive_ctrl_publish
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=dmcs_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=f1_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=f2_consume
python2 rabbitmqadmin.py --username=DMCS --password=DMCS --vhost=/test purge queue name=ar_foreman_ack_publish
