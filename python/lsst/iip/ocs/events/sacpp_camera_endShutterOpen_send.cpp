...
/*
 * This file contains the implementation for the camera_endShutterOpen send test.
 *
 ***/
...
{ 
  ...
  camera_logevent_endShutterOpenC myData;
  if (argc < 2) {
  ...
  mgr.logEvent_endShutterOpen(&myData, priority);
  cout << "=== Event endShutterOpen generated = " << endl;
  sleep(1);
