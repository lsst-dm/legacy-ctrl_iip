...
/*
 * This file contains the implementation for the atArchiver_SummaryState receive test.
 *
 ***/
...
{
  OS_API_EXPORT
  int test_atArchiver_SummaryState_Log();
}
...
{ 
...
#endif
  mgr.salEvent("atArchiver_logevent_SummaryState");
  ...
  // receive event
    ...
    cout << "    priority : " << SALInstance.priority << endl;
     publisher->publish_message("test_dmcs_ocs_publish", "{ MSG_TYPE: SUMMARY_STATE_EVENT, DEVICE: AT, CURRENT_STATE: None }");  
...
{
  return test_atArchiver_SummaryState_Log();
}
