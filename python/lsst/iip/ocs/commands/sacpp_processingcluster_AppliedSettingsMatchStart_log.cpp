...
/*
 * This file contains the implementation for the processingcluster_AppliedSettingsMatchStart receive test.
 *
 ***/
...
{
  OS_API_EXPORT
  int test_processingcluster_AppliedSettingsMatchStart_Log();
}
...
{ 
  ...
  processingcluster_logevent_AppliedSettingsMatchStartC SALInstance;
  ...
  // receive event
    ...
    cout << "    priority : " << SALInstance.priority << endl;
     ...
     publisher->publish_message("test_dmcs_ocs_publish", "{ MSG_TYPE: APPLIED_SETTINGS_MATCH_START_EVENT, DEVICE: PP, SETTING: None, APPLIED: None }");  
    }
...
{
  return test_processingcluster_AppliedSettingsMatchStart_Log();
}
