...
/*
 * This file contains the implementation for the camera_startShutterClose send test.
 *
 ***/
...
{ 
  ...
  camera_logevent_startShutterCloseC myData;
  if (argc < 2) {
  ...
  mgr.logEvent_startShutterClose(&myData, priority);
  cout << "=== Event startShutterClose generated = " << endl;
  sleep(1);
