...
/*
 * This file contains the implementation for the camera_startReadout receive test.
 *
 ***/
...
{
  OS_API_EXPORT
  int test_camera_startReadout_Log();
}
...
{ 
  ...
  cout << "=== Event startReadout logger ready = " << endl;
  SimplePublisher* publisher = new SimplePublisher("amqp://READOUT:READOUT@141.142.208.209/%2fbunny"); 
...
{
  return test_camera_startReadout_Log();
}
