...
/*
 * This file contains the implementation for the camera_startShutterClose receive test.
 *
 ***/
...
{
  OS_API_EXPORT
  int test_camera_startShutterClose_Log();
}
...
{ 
  ...
  SimplePublisher *publisher = new SimplePublisher("amqp://SCLOSE:SCLOSE@141.142.208.209/%2fbunny"); 
  cout << "=== Event startShutterClose logger ready = " << endl;
...
{
  return test_camera_startShutterClose_Log();
}
