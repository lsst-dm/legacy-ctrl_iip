...
/*
 * This file contains the implementation for the camera_startShutterOpen send test.
 *
 ***/
...
{ 
  ...
  camera_logevent_startShutterOpenC myData;
  if (argc < 2) {
  ...
  mgr.logEvent_startShutterOpen(&myData, priority);
  cout << "=== Event startShutterOpen generated = " << endl;
  sleep(1);
