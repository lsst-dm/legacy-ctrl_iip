...
/*
 * This file contains the implementation for the archiver_targetVisitAccept send test.
 *
 ***/
...
{ 
  ...
  archiver_logevent_targetVisitAcceptC myData;
  if (argc < 2) {
  ...
  mgr.logEvent_targetVisitAccept(&myData, priority);
  cout << "=== Event targetVisitAccept generated = " << endl;
  sleep(1);
